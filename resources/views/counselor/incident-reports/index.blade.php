...
<div class="modern-page-header mb-4" style="padding: 1.5rem;">
    <div class="modern-page-header-compact">
        ...
        <div style="flex: 1;">
            ...
            <p class="modern-page-subtitle">Monitor and manage student incident reports</p>
        </div>
    </div>
</div>
                ...
                <div class="modern-list-item" style="padding: 1.25rem; border-bottom: 1px solid #e5e7eb; display: block;">
                    <div style="display: grid; grid-template-columns: 1fr auto; gap: 1rem; align-items: start;">
                        ...
                        <div style="display: flex; gap: 0.5rem; flex-shrink: 0;">
                            <a href="{{ route('counselor.incident-reports.show', $report) }}" 
    ...
    @else
        <div class="modern-empty-state" style="padding: 3rem 1.5rem;">
            ...
            <p class="modern-empty-text">
                ...
                @else
                    No incident reports have been submitted by teachers yet.
                @endif
            </p>
            @if(request()->hasAny(['search', 'status', 'urgency']))
                <a href="{{ route('counselor.incident-reports.index') }}" class="modern-btn modern-btn-secondary" style="padding: 0.625rem 1.25rem; font-size: 0.875rem;">
