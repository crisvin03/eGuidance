...
<div class="modern-page-header mb-4" style="padding: 1.5rem;">
    <div class="modern-page-header-compact">
        ...
        <div style="flex: 1;">
            ...
            <p class="modern-page-subtitle">All referrals you have submitted</p>
        </div>
        <a href="{{ route('teacher.referrals.create') }}" class="modern-btn modern-btn-primary" style="padding: 0.625rem 1.25rem; font-size: 0.875rem; white-space: nowrap;">
...
<div class="modern-card" style="padding: 1.5rem;">
    ...
    @else
        <div class="modern-empty-state" style="padding: 3rem 1.5rem;">
            ...
            @if(request()->hasAny(['search', 'status']))
                <a href="{{ route('teacher.referrals.index') }}" class="modern-btn modern-btn-secondary" style="padding: 0.625rem 1.25rem; font-size: 0.875rem; margin-top: 1rem;">
                    <i class="bi bi-x-circle"></i> Clear Filters
                </a>
            @else
                <a href="{{ route('teacher.referrals.create') }}" class="modern-btn modern-btn-primary" style="padding: 0.625rem 1.25rem; font-size: 0.875rem; margin-top: 1rem;">
                    <i class="bi bi-plus-lg"></i> Create Referral
                </a>
            @endif
        </div>
    @endif
