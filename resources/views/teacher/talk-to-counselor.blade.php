...
<div class="card border-0 shadow-sm mb-4" style="border-radius:16px;">
    <div class="card-header bg-white border-0 pt-4 px-4">
        <h6 class="fw-bold mb-0"><i class="bi bi-calendar-plus me-2" style="color:#1e7a4a;"></i>Schedule an Appointment</h6>
    </div>
    ...
    <div class="card-body px-4 py-3 d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center gap-3">
            <div class="d-flex align-items-center justify-content-center rounded-circle"
                ...
                <i class="bi bi-calendar3 fs-5" style="color:#1e7a4a;"></i>
            </div>
            <div>
        ...
        <a href="{{ route('teacher.appointments.index') }}"
           ...
           style="background:linear-gradient(135deg,#1e7a4a,#145e38);border-radius:10px;">
                ...
                <div class="card-body p-4 text-center d-flex flex-column align-items-center">
                    ...
                    @else
                        <div class="rounded-circle d-flex align-items-center justify-content-center mb-3 fw-bold fs-4 text-white"
                             style="width:80px;height:80px;background:linear-gradient(135deg,#1e7a4a,#145e38);">
                            {{ strtoupper(substr($counselor->name, 0, 2)) }}
                        </div>
                    @endif
                    <h6 class="fw-bold mb-1">{{ $counselor->name }}</h6>
                    <span class="badge mb-3" style="background:rgba(32,178,170,0.1);color:#1e7a4a;">Guidance Counselor</span>
                    <div class="w-100">
                        @if($counselor->email)
...
<div class="alert border-0 mt-4 small" style="border-radius:12px;background:rgba(32,178,170,0.08);border-left:4px solid #1e7a4a !important;">
    <i class="bi bi-lightbulb me-2" style="color:#1e7a4a;"></i>
    <strong>Tip:</strong> For urgent student concerns, use the
    <a href="{{ route('teacher.incident-reports.create') }}" class="fw-semibold" style="color:#1e7a4a;">Incident Report</a>
    or
    <a href="{{ route('teacher.referrals.create') }}" class="fw-semibold" style="color:#1e7a4a;">Referral</a>
